...
class Model(nn.Module):
    ...
    def forward(self, is_train, src: Tensor, trg_input: Tensor, src_mask: Tensor, src_lengths: Tensor, trg_mask: Tensor = None, src_input: Tensor = None) \
        ...
        skel_out = self.diffusio(is_train=is_train, encoder_output=encoder_output, src_mask=src_mask, trg_input=trg_input, trg_mask=trg_mask)
    ...
    def diffusio(self, is_train,encoder_output: Tensor, src_mask: Tensor, trg_input: Tensor, trg_mask: Tensor = None) \
        -> (Tensor, Tensor, Tensor, Tensor):
        ...
        diffusion_output = self.diffusion(encoder_output=encoder_output, input_3d=trg_input, src_mask=src_mask, trg_mask=trg_mask, is_train=is_train)
    ...
    def get_loss_for_batch(self, is_train, batch: Batch, loss_function: nn.Module) -> Tensor:
        ...
        batch_loss = loss_function(skel_out, batch.trg_input)
