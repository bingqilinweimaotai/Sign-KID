...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        LoginWindow.resize(847, 642)
        self.centralwidget = QtWidgets.QWidget(LoginWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(19, 19, 391, 591))
...
"}")
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 50, 301, 51))
        self.label_2.setStyleSheet("font: 13pt \"隶书\";\n"
"")
        self.label_2.setObjectName("label_2")
        self.frame_2 = QtWidgets.QFrame(self.centralwidget)
        self.frame_2.setGeometry(QtCore.QRect(410, 40, 391, 551))
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(354, 0, 41, 30))
...
"}")
        ...
        self.frame_3.setGeometry(QtCore.QRect(0, 20, 391, 512))
        self.frame_3.setMinimumSize(QtCore.QSize(391, 512))
...
"}")
        ...
        self.frame_7.setStyleSheet("QPushButton:pressed{\n"
"    padding-top:5px;\n"
"    padding-left:5px;\n"
"}")
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label_2.setText(_translate("LoginWindow", "基于扩散模型的手语生成"))
        ...
        self.pushButton_Login.setText(_translate("LoginWindow", "用户登录"))
        self.pushButton_Register.setText(_translate("LoginWindow", "用户注册"))
        self.label_4.setText(_translate("LoginWindow", "账号或密码错误！"))
        self.label.setText(_translate("LoginWindow", "账号或密码不能为空！"))
